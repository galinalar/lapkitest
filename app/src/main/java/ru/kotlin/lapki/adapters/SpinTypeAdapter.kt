...
class SpinTypeAdapter(val appcontext: Activity, var items : List<ShelterType>): ArrayAdapter<ShelterType>(appcontext, android.R.layout.simple_spinner_item, items){
